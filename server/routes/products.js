...
//controllers
const { create, listofproducts, removeproduct, listproductsbyslug, update, list, totalproduct, relatedProducts, startrating, getproductsByCategory, getproductsBySubCategory } = require("../controllers/products")
...
router.get('/products/getProductsBySubCategory/:subcategoryName', getproductsBySubCategory)
